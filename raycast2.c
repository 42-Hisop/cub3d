...
/*   Updated: 2021/05/20 02:17:07 by khee-seo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	dist(t_player *player, t_ray *ray)
{
	...
	if (ray->side == 0)
		ray->hit_point = player_pos_y + ray->perpwalldist * ray->raydir_y;
	else
		ray->hit_point = player_pos_x + ray->perpwalldist * ray->raydir_x;

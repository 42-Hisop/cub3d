...
/*   Updated: 2021/05/19 03:12:18 by khee-seo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_step(t_player *player, t_ray *ray)
{
	...
	{
		ray->step_y = 1;
		ray->sidedist_y = (ray->map_y + 1.0 - player_pos_y) * ray->deltadist_y;
	}
}
